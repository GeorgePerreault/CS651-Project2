              ...
              >
                <CardContent className="p-6">
                  <div className="grid gap-6">
                    {!preview ? (
                        <div
                            className={`flex flex-col items-center justify-center border-2 border-dashed rounded-lg p-12 text-center cursor-pointer transition-colors duration-300 group
                      ${isDragging ? "bg-muted/40 border-primary/50 text-primary" : "hover:bg-muted/50"}`}
                            onClick={() =>
                        ...
                        >
                          <Upload className={`h-12 w-12 mb-4 transition-transform duration-300 group-hover:scale-110 ${
                              isDragging
                                  ? "text-primary"
